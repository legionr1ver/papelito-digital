        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r z-30"
                ...
                <div class="mb-4 px-4">
                    ...
                    <div
                        :class="{'bg-gray-200': $page.component === 'Dashboard'}"
                        ...
                        <Link href="/dashboard" class="text-gray-700">Dashboard</Link>
                    </div>
                    <div
                        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
                        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
                ...
                <div class="mb-4 px-4">
                    ...
                    <div
                        :class="{'bg-gray-200': $page.component === 'Invitation/Create'}"
                        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
                        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
                            <path
                        ...
                        <Link class="text-gray-700" href="/invitations/create">Agregar</Link>
                    </div>
                    <div
                        :class="{'bg-gray-200': $page.component === 'Invitations/List'}"
                        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
                        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
                            <path
                        ...
                        <Link class="text-gray-700" href="/invitations">Listar</Link>
                    </div>
                </div>
